...
class SearchSocialNetworksWidget(QWidget):
    ...
    def create_gui(self) -> QLayout:
        ...
        self.search_instagram_url_edit = QLineEdit()
        ...
        self.search_linkedin_url_edit = QLineEdit()
        ...
        self.search_github_url_edit = QLineEdit()
        ...
        self.search_website_url_edit = QLineEdit()
