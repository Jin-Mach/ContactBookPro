...
class PersonalDetailsWidget(QWidget):
    ...
    def create_gui(self) -> QLayout:
        ...
        self.dialog_birthday_text_label = QLabel("birthday:")
        ...
        self.dialog_calendar_pushbutton = QPushButton("calendar")
        self.dialog_calendar_pushbutton.setObjectName("dialogCalendarPushbutton")
        self.dialog_reset_calendar_pushbutton = QPushButton("reset")
