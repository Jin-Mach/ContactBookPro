...
class ManualCheckWidget(QWidget):
    def __init__(self, tree_widget: "ManualTreeWidget", top_item_index: int, parent=None) -> None:
        ...
        ManualInitProvider.apply_tab_texts(self.objectName(), self.manual_check_tab_widget, tab_widgets, self)
    ...
    def create_gui(self) -> QLayout:
        ...
        self.check_missing_coords_text_edit.setObjectName("checkMissingCoordinatesTextEdit")
