...
class ManualStatisticsWidget(QWidget):
    def __init__(self, tree_widget: "ManualTreeWidget", top_item_index: int, parent=None) -> None:
        ...
        ManualInitProvider.apply_tab_texts(self.objectName(), self.manual_statistics_tab_widget, tab_widgets, self)
    ...
    def set_tree_item(self) -> None:
        ...
        if current_item is top_item:
            return
        tab_index = self.manual_statistics_tab_widget.currentIndex()
