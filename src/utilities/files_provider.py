...
class FilesProvider:
    ...
    supported_languages = ["cs_CZ", "de_DE", "en_GB", "es_ES", "fr_FR", "it_IT", "nl_NL", "pl_PL", "pt_PT", "ru_RU"]
    ...
    def check_json_files() -> dict | None:
        ...
        missing_json_urls = {}
        try:
            for language in FilesProvider.supported_languages:
            ...
            ErrorHandler.write_log_exception(FilesProvider.__class__.__name__, e)
            return None
        return missing_json_urls

    @staticmethod
    def check_icon_files() -> dict | None:
        required_files = ["githubButton_icon.png",
            ...
            "contactCheckBirthdayAction_icon.png", "contactCheckDuplicityAction_icon.png", "contactsCheckCoordsAction_icon.png", "copyEmailAction_icon.png",
            ...
            "mainWindowMapButton_icon.png", "mainWindowAboutButton_icon.png", "mainWindowDatabaseButton_icon.png",
            "mainWindowStatisticsButton_icon.png", "openApplicationButton_icon.png", "pdfFitPageButton_icon.png",
        ...
        icon_folders = {
            ...
            "contactsCheckCoordsAction_icon.png": "contextMenu",
            ...
            "noContactImage.png": "exportContactPdfObject",
            ...
            "openApplicationButton_icon.png": "pdfPreviewDialog",
        ...
        icon_files_path = FilesProvider.default_path.joinpath("icons")
    ...
    @staticmethod
    def check_font_files() -> dict | None:
        required_fonts = ["TimesNewRoman.ttf"]
        fonts_directory = FilesProvider.default_path.joinpath("fonts")
    ...
    @staticmethod
    def check_manual_files() -> dict | None:
        required_files = [
        ...
        txt_file_path = FilesProvider.default_path.joinpath("languages")
    ...
    @staticmethod
    def check_about_files() -> dict | None:
        required_files = ["aboutApplicationTextEdit.html"]
        html_base_path = FilesProvider.default_path.joinpath("languages")
